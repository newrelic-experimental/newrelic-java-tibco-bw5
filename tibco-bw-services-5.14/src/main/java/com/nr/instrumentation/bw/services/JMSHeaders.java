...
public class JMSHeaders implements Headers {
	...
	public String getHeader(String name) {
		...
		try {
			...
			NewRelic.getAgent().getLogger().log(Level.FINEST, e, "Failed to get header {0}",name);
		}
		return null;
	}
	...
	public void setHeader(String name, String value) {
		try {
			...
			NewRelic.getAgent().getLogger().log(Level.FINEST, e, "Failed to set header {0} to value {1}",name,value);
		}
	}
